...
def cross_val(X,y):
    ...
    print(np.mean(accuracy),file = open('death_smote_rf_ehr_claim.out', 'a'))
    print(np.mean(f1),file = open('death_smote_rf_ehr_claim.out', 'a'))
    print(np.mean(f2),file = open('death_smote_rf_ehr_claim.out', 'a'))
    print(np.mean(auc),file = open('death_smote_rf_ehr_claim.out', 'a'))
    print(np.mean(log_loss),file = open('death_smote_rf_ehr_claim.out', 'a'))
...
print("Low",file = open('death_smote_rf_ehr_claim.out', 'a'))
...
print("High",file = open('death_smote_rf_ehr_claim.out', 'a'))
