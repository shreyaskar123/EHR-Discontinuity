...
def scores(X,y):
    ...
    actual = y
    print(accuracy_score(actual,pred), file = open('hemorrhage_smote_rf_ehr.out', 'a'))
    print(f1_score(actual,pred), file = open('hemorrhage_smote_rf_ehr.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2), file = open('hemorrhage_smote_rf_ehr.out', 'a'))
   
    print(roc_auc_score(actual,best_clf.predict_proba(X)[:,1]), file = open('hemorrhage_smote_rf_ehr.out', 'a'))
    print(log_loss(actual,pred), file = open('hemorrhage_smote_rf_ehr.out', 'a'))
...
def cross_val(X,y):
    ...
    print(np.mean(accuracy), file = open('hemorrhage_smote_rf_ehr.out', 'a'))
    print(np.mean(f1), file = open('hemorrhage_smote_rf_ehr.out', 'a'))
    print(np.mean(f2), file = open('hemorrhage_smote_rf_ehr.out', 'a'))
    print(np.mean(auc), file = open('hemorrhage_smote_rf_ehr.out', 'a'))
    print(np.mean(log_loss), file = open('hemorrhage_smote_rf_ehr.out', 'a'))
...
print("gpop 2 Sep", file = open('hemorrhage_smote_rf_ehr.out', 'a'))
cross_val(co_train_gpop_sm, out_train_hemorrhage_gpop_sm)

print("", file = open('hemorrhage_smote_rf_ehr.out', 'a'))
