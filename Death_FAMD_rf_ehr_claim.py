...
print("Gpop",file = open('death_famd_rf_ehr_claims.out', 'a'))
...
print("Low",file = open('death_famd_rf_ehr_claims.out', 'a'))
...
print("High",file = open('death_famd_rf_ehr_claims.out', 'a'))
