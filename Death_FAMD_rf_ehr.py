...
def cross_val(X,y):
    ...
    print(np.mean(accuracy),file = open('death_famd_rf_ehr.out', 'a'))
    print(np.mean(f1),file = open('death_famd_rf_ehr.out', 'a'))
    print(np.mean(f2),file = open('death_famd_rf_ehr.out', 'a'))
    print(np.mean(auc),file = open('death_famd_rf_ehr.out', 'a'))
    print(np.mean(log_loss),file = open('death_famd_rf_ehr.out', 'a'))
...
print("Gpop",file = open('death_famd_rf_ehr.out', 'a'))
...
print("Low",file = open('death_famd_rf_ehr.out', 'a'))
...
print("High",file = open('death_famd_rf_ehr.out', 'a'))


cross_val(co_train_high_FAMD, out_train_death_high)

print("",file = open('death_famd_rf_ehr.out', 'a'))
