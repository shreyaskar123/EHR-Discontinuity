...
print("Low",file = open('death_no_rf_ehr.out', 'a'))
...
print("High",file = open('death_no_rf_ehr.out', 'a'))
...
#print(datetime.datetime.now() - begin_time,file = open('death_no_rf_ehr.out', 'a'))
