...
def scores(X,y):
    ...
    actual = y
    print(accuracy_score(actual,np.round(pred)),file = open('comp_nd_bart_famd.out', 'a'))
    print(f1_score(actual,np.round(pred)),file = open('comp_nd_bart_famd.out', 'a'))
    print(fbeta_score(actual,np.round(pred), average = 'macro', beta = 2),file = open('comp_nd_bart_famd.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict(X)),file = open('comp_nd_bart_famd.out', 'a'))
    print(log_loss(actual,best_clf.predict(X)),file = open('comp_nd_bart_famd.out', 'a'))
...
def cross_val(X,y):
    ...
    print(np.mean(accuracy),file = open('comp_nd_bart_famd.out', 'a'))
    print(np.mean(f1),file = open('comp_nd_bart_famd.out', 'a'))
    print(np.mean(f2),file = open('comp_nd_bart_famd.out', 'a'))
    print(np.mean(auc),file = open('comp_nd_bart_famd.out', 'a'))
    print(np.mean(log_loss),file = open('comp_nd_bart_famd.out', 'a'))
