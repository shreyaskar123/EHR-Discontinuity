...
def scores(X,y):
    ...
    actual = y
    print(accuracy_score(actual,pred), file = open('comp_nd_famd_rf_ehrc.out', 'a'))
    print(f1_score(actual,pred), file = open('comp_nd_famd_rf_ehrc.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2), file = open('comp_nd_famd_rf_ehrc.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict_proba(X)[:,1]), file = open('comp_nd_famd_rf_ehrc.out', 'a'))
    print(log_loss(actual,best_clf.predict_proba(X)[:,1]), file = open('comp_nd_famd_rf_ehrc.out', 'a'))
...
def cross_val(X,y):
    ...
    print(np.mean(accuracy), file = open('comp_nd_famd_rf_ehrc.out', 'a'))
    print(np.mean(f1), file = open('comp_nd_famd_rf_ehrc.out', 'a'))
    print(np.mean(f2), file = open('comp_nd_famd_rf_ehrc.out', 'a'))
    print(np.mean(auc), file = open('comp_nd_famd_rf_ehrc.out', 'a'))
    print(np.mean(log_loss), file = open('comp_nd_famd_rf_ehrc.out', 'a'))
...
print("gpop Sep 12", file = open('comp_nd_famd_rf_ehrc.out', 'a'))

best_clf = rf(co_train_gpop_FAMD, out_train_comp_gpop)

cross_val(co_train_gpop_FAMD, out_train_comp_gpop)

print("", file = open('comp_nd_famd_rf_ehrc.out', 'a'))
...
print("low", file = open('comp_nd_famd_rf_ehrc.out', 'a'))

best_clf = rf(co_train_low_FAMD, out_train_comp_low)
...
print("high", file = open('comp_nd_famd_rf_ehrc.out', 'a'))

best_clf = rf(co_train_high_FAMD, out_train_comp_high)
