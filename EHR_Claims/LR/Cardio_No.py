...
def scores(X_train,y_train):
    ...
    actual = y_train
    print(accuracy_score(actual,pred),file = open('cardio_d_no_lr_ehr_claims.out', 'a'))
    print(f1_score(actual,pred),file = open('cardio_d_no_lr_ehr_claims.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2),file = open('cardio_d_no_lr_ehr_claims.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict_proba(X_train)[:,1]),file = open('cardio_d_no_lr_ehr_claims.out', 'a'))
    print(log_loss(actual,best_clf.predict_proba(X_train)[:,1]),file = open('cardio_d_no_lr_ehr_claims.out', 'a'))
...
def cross_val(X,y):
    ...
    print(np.mean(accuracy),file = open('cardio_d_no_lr_ehr_claims.out', 'a'))
    print(np.mean(f1),file = open('cardio_d_no_lr_ehr_claims.out', 'a'))
    print(np.mean(f2),file = open('cardio_d_no_lr_ehr_claims.out', 'a'))
    print(np.mean(auc),file = open('cardio_d_no_lr_ehr_claims.out', 'a'))
    print(np.mean(log_loss),file = open('cardio_d_no_lr_ehr_claims.out', 'a'))


# In[8]:


print("Gpop",file = open('cardio_d_no_lr_ehr_claims.out', 'a'))
best_clf = lr(co_train_gpop, out_train_cardio_gpop)
scores(co_train_gpop, out_train_cardio_gpop)
print()
print("",file = open('cardio_d_no_lr_ehr_claims.out', 'a'))
...
print("Low",file = open('cardio_d_no_lr_ehr_claims.out', 'a'))
...
print("High",file = open('cardio_d_no_lr_ehr_claims.out', 'a'))
