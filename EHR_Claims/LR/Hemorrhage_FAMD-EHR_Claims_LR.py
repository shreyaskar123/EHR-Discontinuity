...
def scores(X,y):
    ...
    print("", file = open('hem_famd_lr_ehrc.out', 'a'))

    
    print(accuracy_score(actual,pred),file = open('hem_famd_lr_ehrc.out', 'a'))
    print(f1_score(actual,pred),file = open('hem_famd_lr_ehrc.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2),file = open('hem_famd_lr_ehrc.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict_proba(X)[:,1]),file = open('hem_famd_lr_ehrc.out', 'a'))
    print(log_loss(actual,best_clf.predict_proba(X)[:,1]),file = open('hem_famd_lr_ehrc.out', 'a'))
...
def cross_val(X,y):
    ...
    print(np.mean(accuracy),file = open('hem_famd_lr_ehrc.out', 'a'))
    print(np.mean(f1),file = open('hem_famd_lr_ehrc.out', 'a'))
    print(np.mean(f2),file = open('hem_famd_lr_ehrc.out', 'a'))
    print(np.mean(auc),file = open('hem_famd_lr_ehrc.out', 'a'))
    print(np.mean(log_loss),file = open('hem_famd_lr_ehrc.out', 'a'))
...
best_clf = lr(co_train_gpop_FAMD, out_train_hemorrhage_gpop)
print("Gpop", file = open('hem_famd_lr_ehrc.out', 'a'))
...
print("High", file = open('hem_famd_lr_ehrc.out', 'a'))

best_clf = lr(co_train_high_FAMD, out_train_hemorrhage_high)
...
print("low", file = open('hem_famd_lr_ehrc.out', 'a'))

best_clf = lr(co_train_low_FAMD, out_train_hemorrhage_low)
