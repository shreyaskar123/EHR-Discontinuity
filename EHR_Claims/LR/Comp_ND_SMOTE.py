...
def scores(X,y):
    ...
    actual = y
    #file = open('comp_smote_lr_ehrcout', 'a')
    print(accuracy_score(actual,pred),file = open('comp_smote_lr_ehrcout', 'a'))
    #print(f1_score(actual,pred),file = open('comp_smote_lr_ehrcout', 'a'))
    print(f1_score(actual,pred, average = 'macro'),file = open('comp_smote_lr_ehrcout', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2),file = open('comp_smote_lr_ehrcout', 'a'))
    print(roc_auc_score(actual, best_clf.predict_proba(X)[:,1]),file = open('comp_smote_lr_ehrcout', 'a'))
    print(log_loss(actual,best_clf.predict_proba(X)[:,1]),file = open('comp_smote_lr_ehrcout', 'a'))
...
def cross_val(X,y,Or_X, Or_y):
    ...
    print(np.mean(accuracy),file = open('comp_smote_lr_ehrcout', 'a'))
    print(np.mean(f1),file = open('comp_smote_lr_ehrcout', 'a'))
    print(np.mean(f2),file = open('comp_smote_lr_ehrcout', 'a'))
    print(np.mean(auc),file = open('comp_smote_lr_ehrcout', 'a'))
    print(np.mean(log_loss),file = open('comp_smote_lr_ehrcout', 'a'))
...
print("Gpop",file = open('comp_smote_lr_ehrcout', 'a'))
...
print("",file = open('comp_smote_lr_ehrcout', 'a'))
...
print("Low",file = open('comp_smote_lr_ehrcout', 'a'))
from imblearn.over_sampling import SMOTE
sm = SMOTE(random_state = 42)
...
print("High",file = open('comp_smote_lr_ehrcout', 'a'))
from imblearn.over_sampling import SMOTE
sm = SMOTE(random_state = 42)
