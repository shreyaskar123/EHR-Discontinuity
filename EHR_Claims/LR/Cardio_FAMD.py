...
def scores(X_train,y_train):
    ...
    actual = y_train
    print(accuracy_score(actual,pred),file = open('comp_nd_famd_lr_ehr_claims.out', 'a'))
    print(f1_score(actual,pred),file = open('comp_nd_famd_lr_ehr_claims.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2),file = open('comp_nd_famd_lr_ehr_claims.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict_proba(X_train)[:,1]),file = open('comp_nd_famd_lr_ehr_claims.out', 'a'))
    print(log_loss(actual,best_clf.predict_proba(X_train)[:,1]),file = open('comp_nd_famd_lr_ehr_claims.out', 'a'))
...
def cross_val(X,y):
    ...
    print(np.mean(accuracy),file = open('comp_nd_famd_lr_ehr_claims.out', 'a'))
    print(np.mean(f1),file = open('comp_nd_famd_lr_ehr_claims.out', 'a'))
    print(np.mean(f2),file = open('comp_nd_famd_lr_ehr_claims.out', 'a'))
    print(np.mean(auc),file = open('comp_nd_famd_lr_ehr_claims.out', 'a'))
    print(np.mean(log_loss),file = open('comp_nd_famd_lr_ehr_claims.out', 'a'))
...
print("Gpop",file = open('comp_nd_famd_lr_ehr_claims.out', 'a'))
...
print("",file = open('comp_nd_famd_lr_ehr_claims.out', 'a'))
...
print("Low",file = open('comp_nd_famd_lr_ehr_claims.out', 'a'))
...
print("High",file = open('comp_nd_famd_lr_ehr_claims.out', 'a'))
