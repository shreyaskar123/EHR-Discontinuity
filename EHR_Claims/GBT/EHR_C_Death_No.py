...
def scores(X,y):
    ...
    actual = y
    print(accuracy_score(actual,pred), file = open('death_no_gbt_ehr_claims.out', 'a'))
    print(f1_score(actual,pred), file = open('death_no_gbt_ehr_claims.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2), file = open('death_no_gbt_ehr_claims.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict_proba(X)[:,1]), file = open('death_no_gbt_ehr_claims.out', 'a'))
    print(log_loss(actual,best_clf.predict_proba(X)[:,1]), file = open('death_no_gbt_ehr_claims.out', 'a'))
...
def cross_val(X,y):
    ...
    print(np.mean(accuracy), file = open('death_no_gbt_ehr_claims.out', 'a'))
    print(np.mean(f1), file = open('death_no_gbt_ehr_claims.out', 'a'))
    print(np.mean(f2), file = open('death_no_gbt_ehr_claims.out', 'a'))
    print(np.mean(auc), file = open('death_no_gbt_ehr_claims.out', 'a'))
    print(np.mean(log_loss), file = open('death_no_gbt_ehr_claims.out', 'a'))
