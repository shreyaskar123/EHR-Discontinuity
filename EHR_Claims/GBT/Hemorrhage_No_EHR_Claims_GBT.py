...
def scores(X,y):
    ...
    actual = y
    print(accuracy_score(actual,pred),file = open('hem_no_gbt_ehrc.out', 'a'))
    print(f1_score(actual,pred),file = open('hem_no_gbt_ehrc.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2),file = open('hem_no_gbt_ehrc.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict_proba(X)[:,1]),file = open('hem_no_gbt_ehrc.out', 'a'))
    print(log_loss(actual,best_clf.predict_proba(X)[:,1]),file = open('hem_no_gbt_ehrc.out', 'a'))
...
def cross_val(X,y):
    ...
    print(np.mean(accuracy),file = open('hem_no_gbt_ehrc.out', 'a'))
    print(np.mean(f1),file = open('hem_no_gbt_ehrc.out', 'a'))
    print(np.mean(f2),file = open('hem_no_gbt_ehrc.out', 'a'))
    print(np.mean(auc),file = open('hem_no_gbt_ehrc.out', 'a'))
    print(np.mean(log_loss),file = open('hem_no_gbt_ehrc.out', 'a'))
...
best_clf = xgBoost(co_train_gpop, out_train_hemorrhage_gpop)

cross_val(co_train_gpop, out_train_hemorrhage_gpop)

print("",file = open('hem_no_gbt_ehrc.out', 'a'))
...
print("High",file = open('hem_no_gbt_ehrc.out', 'a'))

best_clf = xgBoost(co_train_high, out_train_hemorrhage_high)
...
best_clf = xgBoost(co_train_low, out_train_hemorrhage_low)
print("Low",file = open('hem_no_gbt_ehrc.out', 'a'))
