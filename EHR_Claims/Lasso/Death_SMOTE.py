...
def scores(X,y):
    ...
    actual = y
    #file = open('death_smote_lasso_ehrc.out', 'a')
    print(accuracy_score(actual,pred),file = open('death_smote_lasso_ehrc.out', 'a'))
    print(f1_score(actual,pred,average = 'macro'),file = open('death_smote_lasso_ehrc.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2),file = open('death_smote_lasso_ehrc.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict(X)),file = open('death_smote_lasso_ehrc.out', 'a'))
    print(log_loss(actual,best_clf.predict(X)),file = open('death_smote_lasso_ehrc.out', 'a'))
...
def cross_val(X,y,Or_X, Or_y):
    ...
    print(np.mean(accuracy),file = open('death_smote_lasso_ehrc.out', 'a'))
    print(np.mean(f1),file = open('death_smote_lasso_ehrc.out', 'a'))
    print(np.mean(f2),file = open('death_smote_lasso_ehrc.out', 'a'))
    print(np.mean(auc),file = open('death_smote_lasso_ehrc.out', 'a'))
    print(np.mean(log_loss),file = open('death_smote_lasso_ehrc.out', 'a'))
...
print("Gpop",file = open('death_smote_lasso_ehrc.out', 'a'))
...
print("",file = open('death_smote_lasso_ehrc.out', 'a'))
...
print("Low",file = open('death_smote_lasso_ehrc.out', 'a'))
from imblearn.over_sampling import SMOTE
sm = SMOTE(random_state = 42)
...
print("High",file = open('death_smote_lasso_ehrc.out', 'a'))
from imblearn.over_sampling import SMOTE
sm = SMOTE(random_state = 42)
