...
def scores(X_train,y_train, best_clf):
    ...
    print(pred)
    actual = y_train
    print(accuracy_score(actual,pred), file = open('comp_smote_bart_ehr_claims.out', 'a'))
    print(f1_score(actual,pred), file = open('comp_smote_bart_ehr_claims.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2),  file = open('comp_smote_bart_ehr_claims.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict(X_train)),  file = open('comp_smote_bart_ehr_claims.out', 'a'))
    print(log_loss(actual,best_clf.predict(X_train)),  file = open('comp_smote_bart_ehr_claims.out', 'a'))
...
def cross_val(X,y):
    ...
    print(np.mean(accuracy),  file = open('comp_smote_bart_ehr_claims.out', 'a'))
    print(np.mean(f1),  file = open('comp_smote_bart_ehr_claims.out', 'a'))
    print(np.mean(f2),  file = open('comp_smote_bart_ehr_claims.out', 'a'))
    print(np.mean(auc),  file = open('comp_smote_bart_ehr_claims.out', 'a'))
    print(np.mean(log_loss),  file = open('comp_bacomp_smote_bart_ehr_claimsrt_smote.out', 'a'))
...
print("Train gpop",  file = open('comp_smote_bart_ehr_claims.out', 'a'))
cross_val(co_train_gpop_sm,out_train_comp_gpop_sm)

print()
print("Original Train gpop",  file = open('comp_smote_bart_ehr_claims.out', 'a'))

scores(co_train_gpop, out_train_comp_gpop, best_clf)

print() 
print("Test gpop",  file = open('comp_smote_bart_ehr_claims.out', 'a'))
...
print("Train low",  file = open('comp_smote_bart_ehr_claims.out', 'a'))

cross_val(co_train_low_sm,out_train_comp_low_sm)

print()

print("Original Train low",  file = open('comp_smote_bart_ehr_claims.out', 'a'))

scores(co_train_low, out_train_comp_low, best_clf)

print() 

print("Test low",  file = open('comp_smote_bart_ehr_claims.out', 'a'))
...
print("Train high",  file = open('comp_smote_bart_ehr_claims.out', 'a'))

cross_val(co_train_high_sm,out_train_comp_high_sm)

print()

print("Original Train high", file = open('comp_smote_bart_ehr_claims.out', 'a'))

scores(co_train_high, out_train_comp_high, best_clf)

print() 

print("Test high", file = open('comp_smote_bart_ehr_claims..out', 'a'))
