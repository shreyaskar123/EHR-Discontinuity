...
def scores(X_train,y_train, best_clf):
    ...
    print(pred)
    actual = y_train
    print(accuracy_score(actual,pred),file = open('death_smote_bart_ehr.out', 'a'))
    print(f1_score(actual,pred),file = open('death_smote_bart_ehr.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2),file = open('death_smote_bart_ehr.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict(X_train)),file = open('death_smote_bart_ehr.out', 'a'))
    print(log_loss(actual,best_clf.predict(X_train)),file = open('death_smote_bart_ehr.out', 'a'))
...
def cross_val(X,y,Or_X, Or_y):
    ...
    print(np.mean(accuracy),file = open('death_smote_bart_ehr.out', 'a'))
    print(np.mean(f1),file = open('death_smote_bart_ehr.out', 'a'))
    print(np.mean(f2),file = open('death_smote_bart_ehr.out', 'a'))
    print(np.mean(auc),file = open('death_smote_bart_ehr.out', 'a'))
    print(np.mean(log_loss),file = open('death_smote_bart_ehr.out', 'a'))


print("Gpop",file = open('death_smote_bart_ehr.out', 'a'))
import datetime
...
print("",file = open('death_smote_bart_ehr.out', 'a'))
...
print("Low",file = open('death_smote_bart_ehr.out', 'a'))
import datetime
begin_time = datetime.datetime.now()
...
print("High",file = open('death_smote_bart_ehr.out', 'a'))
import datetime
begin_time = datetime.datetime.now()
