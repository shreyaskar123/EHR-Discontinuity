...
def scores(X_train,y_train, best_clf):
    ...
    print(pred)
    actual = y_train
    #print(accuracy_score(actual,pred),file = open('comp_nd_smote_bart_ehr.out', 'a’))
    #print(f1_score(actual,pred),file = open('comp_nd_smote_bart_ehr.out', 'a’))
    #print(fbeta_score(actual,pred, average = 'macro', beta = 2),file = open('comp_nd_smote_bart_ehr.out', 'a’))
    #print(roc_auc_score(actual, best_clf.predict(X_train)),file = open('comp_nd_smote_bart_ehr.out', 'a’))
    #print(log_loss(actual,best_clf.predict(X_train)),file = open('comp_nd_smote_bart_ehr.out', 'a’))
    print(accuracy_score(actual,pred),file = open('comp_nd_smote_bart_ehr.out', 'a'))
    print(f1_score(actual,pred),file = open('comp_nd_smote_bart_ehr.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2),file = open('comp_nd_smote_bart_ehr.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict(X_train)),file = open('comp_nd_smote_bart_ehr.out', 'a'))
...
def cross_val(X,y,Or_X, Or_y):
    ...
    print(np.mean(accuracy),file = open('comp_nd_smote_bart_ehr.out', 'a'))
    print(np.mean(f1),file = open('comp_nd_smote_bart_ehr.out', 'a'))
    print(np.mean(f2),file = open('comp_nd_smote_bart_ehr.out', 'a'))
    print(np.mean(auc),file = open('comp_nd_smote_bart_ehr.out', 'a'))
    #print(np.mean(log_loss),file = open('comp_nd_smote_bart_ehr.out','a’))
    print(np.mean(log_loss),file = open('comp_nd_smote_bart_ehr.out', 'a'))


print("Gpop",file = open('comp_nd_smote_bart_ehr.out', 'a'))
...
print("",file = open('comp_nd_smote_bart_ehr.out', 'a'))
...
print("Low",file = open('comp_nd_smote_bart_ehr.out', 'a'))
...
print("High",file = open('comp_nd_smote_bart_ehr.out', 'a'))
