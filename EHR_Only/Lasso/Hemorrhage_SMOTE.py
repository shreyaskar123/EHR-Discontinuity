...
def scores(X,y):
    ...
    actual = y
    #file = open('hem_smote_lasso_ehr.out', 'a')
    print(accuracy_score(actual,pred),file = open('hem_smote_lasso_ehr.out', 'a'))
    print(f1_score(actual,pred),file = open('hem_smote_lasso_ehr.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2),file = open('hem_smote_lasso_ehr.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict(X)),file = open('hem_smote_lasso_ehr.out', 'a'))
    print(log_loss(actual,best_clf.predict(X)),file = open('hem_smote_lasso_ehr.out', 'a'))
...
def cross_val(X,y,Or_X, Or_y):
    ...
    print(np.mean(accuracy),file = open('hem_smote_lasso_ehr.out', 'a'))
    print(np.mean(f1),file = open('hem_smote_lasso_ehr.out', 'a'))
    print(np.mean(f2),file = open('hem_smote_lasso_ehr.out', 'a'))
    print(np.mean(auc),file = open('hem_smote_lasso_ehr.out', 'a'))
    print(np.mean(log_loss),file = open('hem_smote_lasso_ehr.out', 'a'))
...
print("Gpop",file = open('hem_smote_lasso_ehr.out', 'a'))
...
print("",file = open('hem_smote_lasso_ehr.out', 'a'))
...
print("Low",file = open('hem_smote_lasso_ehr.out', 'a'))
from imblearn.over_sampling import SMOTE
sm = SMOTE(random_state = 42)
...
print("High",file = open('hem_smote_lasso_ehr.out', 'a'))
from imblearn.over_sampling import SMOTE
sm = SMOTE(random_state = 42)
