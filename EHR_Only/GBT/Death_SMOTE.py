...
print("Gpop",file = open('death_smote_gbt_ehrc.out', 'a'))
from imblearn.over_sampling import SMOTE
...
print("",file = open('death_smote_gbt_ehrc.out', 'a'))
...
print("High",file = open('death_smote_gbt_ehrc.out', 'a'))
from imblearn.over_sampling import SMOTE
sm = SMOTE(random_state = 42)
...
print("Low",file = open('death_smote_gbt_ehrc.out', 'a'))
