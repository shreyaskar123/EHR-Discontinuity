...
out_validation_hemorrhage_low = validation_set_low['ehr_claims_death']
...
def scores(X,y):
    ...
    actual = y
    print(accuracy_score(actual,pred),file = open('hem_smote_gbt_ehr.out', 'a'))
    print(f1_score(actual,pred),file = open('hem_smote_gbt_ehr.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2),file = open('hem_smote_gbt_ehr.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict_proba(X)[:,1]),file = open('hem_smote_gbt_ehr.out', 'a'))
    print(log_loss(actual,best_clf.predict_proba(X)[:,1]),file = open('hem_smote_gbt_ehr.out', 'a'))
...
def cross_val(X,y):
    ...
    print(np.mean(accuracy),file = open('hem_smote_gbt_ehr.out', 'a'))
    print(np.mean(f1),file = open('hem_smote_gbt_ehr.out', 'a'))
    print(np.mean(f2),file = open('hem_smote_gbt_ehr.out', 'a'))
    print(np.mean(auc),file = open('hem_smote_gbt_ehr.out', 'a'))
    print(np.mean(log_loss),file = open('hem_smote_gbt_ehr.out', 'a'))
...
print("Gpop",file = open('hem_smote_gbt_ehr.out', 'a'))
from imblearn.over_sampling import SMOTE
...
print("",file = open('hem_smote_gbt_ehr.out', 'a'))
...
print("high",file = open('hem_smote_gbt_ehr.out', 'a'))
...
print("low",file = open('hem_smote_gbt_ehr.out', 'a'))
