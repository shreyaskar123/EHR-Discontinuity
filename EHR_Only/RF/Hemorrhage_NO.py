...
def cross_val(X,y):
    ...
    print(np.mean(accuracy),file = open('hem__no_rf_ehr_claims.out', 'a'))
    print(np.mean(f1),file = open('hem__no_rf_ehr_claims.out', 'a'))
    print(np.mean(f2),file = open('hem__no_rf_ehr_claims.out', 'a'))
    print(np.mean(auc),file = open('hem__no_rf_ehr_claims.out', 'a'))
    print(np.mean(log_loss),file = open('hem__no_rf_ehr_claims.out', 'a'))
...
print("",file = open('hem__no_rf_ehr_claims.out', 'a'))
print("gpop 2 Sep 2nd run both train and test",file = open('hem__no_rf_ehr_claims.out', 'a'))
...
print("Low",file = open('hem__no_rf_ehr_claims.out', 'a'))
...
print("High",file = open('hem__no_rf_ehr_claims.out', 'a'))
