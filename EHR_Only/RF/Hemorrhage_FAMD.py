...
def scores(X,y):
    ...
    actual = y
    print(accuracy_score(actual,pred), file = open('hem_famd_rf_ehr.out', 'a'))
    print(f1_score(actual,pred), file = open('hem_famd_rf_ehr.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2), file = open('hem_famd_rf_ehr.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict_proba(X)[:,1]), file = open('hem_famd_rf_ehr.out', 'a'))
    print(log_loss(actual,best_clf.predict_proba(X)[:,1]), file = open('hem_famd_rf_ehr.out', 'a'))
...
def cross_val(X,y):
    ...
    print(np.mean(accuracy), file = open('hem_famd_rf_ehr.out', 'a'))
    print(np.mean(f1), file = open('hem_famd_rf_ehr.out', 'a'))
    print(np.mean(f2), file = open('hem_famd_rf_ehr.out', 'a'))
    print(np.mean(auc), file = open('hem_famd_rf_ehr.out', 'a'))
    print(np.mean(log_loss), file = open('hem_famd_rf_ehr.out', 'a'))
...
print("", file = open('hem_famd_rf_ehr.out', 'a'))
print("gpop 2 Sep", file = open('hem_famd_rf_ehr.out', 'a'))
#
...
print("high", file = open('hem_famd_rf_ehr.out', 'a'))
