...
def scores(X,y):
    ...
    actual = y
    print(accuracy_score(actual,pred), file = open('comp_d_famd_rf_ehr.out', 'a'))
    print(f1_score(actual,pred), file = open('comp_d_famd_rf_ehr.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2), file = open('comp_d_famd_rf_ehr.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict_proba(X)[:,1]), file = open('comp_d_famd_rf_ehr.out', 'a'))
    print(log_loss(actual,best_clf.predict_proba(X)[:,1]), file = open('comp_d_famd_rf_ehr.out', 'a'))
...
def cross_val(X,y):
    ...
    print(np.mean(accuracy), file = open('comp_d_famd_rf_ehr.out', 'a'))
    print(np.mean(f1), file = open('comp_d_famd_rf_ehr.out', 'a'))
    print(np.mean(f2), file = open('comp_d_famd_rf_ehr.out', 'a'))
    print(np.mean(auc), file = open('comp_d_famd_rf_ehr.out', 'a'))
    print(np.mean(log_loss), file = open('comp_d_famd_rf_ehr.out', 'a'))
...
print("Low", file = open('comp_d_famd_rf_ehr.out', 'a'))
...
print("High", file = open('comp_d_famd_rf_ehr.out', 'a'))
