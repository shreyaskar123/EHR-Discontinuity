...
def cross_val(X,y):
    ...
    print(np.mean(accuracy),file = open('comp_d_smote_rf_ehr.out', 'a'))
    print(np.mean(f1),file = open('comp_d_smote_rf_ehr.out', 'a'))
    print(np.mean(f2),file = open('comp_d_smote_rf_ehr.out', 'a'))
    print(np.mean(auc),file = open('comp_d_smote_rf_ehr.out', 'a'))
    print(np.mean(log_loss),file = open('comp_d_smote_rf_ehr.out', 'a'))
...
print("Gpop 3 Sep",file = open('comp_d_smote_rf_ehr.out', 'a'))
...
print("",file = open('comp_d_smote_rf_ehr.out', 'a'))
...
print("Low",file = open('comp_d_smote_rf_ehr.out', 'a'))
...
print("High",file = open('comp_d_smote_rf_ehr.out', 'a'))
# In[13]:
