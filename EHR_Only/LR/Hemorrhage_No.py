...
def train_scores(X_train,y_train):
    ...
    actual = y_train
    print(accuracy_score(actual,pred),file = open('hem_no_lr_ehr.out', 'a'))
    print(f1_score(actual,pred),file = open('hem_no_lr_ehr.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2),file = open('hem_no_lr_ehr.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict_proba(X_train)[:,1]),file = open('hem_no_lr_ehr.out', 'a'))
    print(log_loss(actual,best_clf.predict_proba(X_train)[:,1]),file = open('hem_no_lr_ehr.out', 'a'))
...
def test_scores(X_test,y_test):
    ...
    print(f1_score(actual,pred),file = open('hem_no_lr_ehr.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2),file = open('hem_no_lr_ehr.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict_proba(X_test)[:,1]),file = open('hem_no_lr_ehr.out', 'a'))
    print(log_loss(actual,best_clf.predict_proba(X_test)[:,1]),file = open('hem_no_lr_ehr.out', 'a'))
...
def cross_val(X,y):
    ...
    print(np.mean(accuracy),file = open('hem_no_lr_ehr.out', 'a'))
    print(np.mean(f1),file = open('hem_no_lr_ehr.out', 'a'))
    print(np.mean(f2),file = open('hem_no_lr_ehr.out', 'a'))
    print(np.mean(auc),file = open('hem_no_lr_ehr.out', 'a'))
    print(np.mean(log_loss),file = open('hem_no_lr_ehr.out', 'a'))
...
print("High",file = open('hem_no_lr_ehr.out', 'a'))
...
print("Low",file = open('hem_no_lr_ehr.out', 'a'))
