...
def scores(X_train,y_train):
    ...
    actual = y_train
    print(accuracy_score(actual,pred),file = open('cardio_nd_famd_lr_ehr.out', 'a'))
    print(f1_score(actual,pred),file = open('cardio_nd_famd_lr_ehr.out', 'a'))
    print(fbeta_score(actual,pred, average = 'macro', beta = 2),file = open('cardio_nd_famd_lr_ehr.out', 'a'))
    print(roc_auc_score(actual, best_clf.predict_proba(X_train)[:,1]),file = open('cardio_nd_famd_lr_ehr.out', 'a'))
    print(log_loss(actual,best_clf.predict_proba(X_train)[:,1]),file = open('cardio_nd_famd_lr_ehr.out', 'a'))
...
def cross_val(X,y):
    ...
    print(np.mean(accuracy),file = open('cardio_nd_famd_lr_ehr.out', 'a'))
    print(np.mean(f1),file = open('cardio_nd_famd_lr_ehr.out', 'a'))
    print(np.mean(f2),file = open('cardio_nd_famd_lr_ehr.out', 'a'))
    print(np.mean(auc),file = open('cardio_nd_famd_lr_ehr.out', 'a'))
    print(np.mean(log_loss),file = open('cardio_nd_famd_lr_ehr.out', 'a'))
...
print("Low",file = open('cardio_nd_famd_lr_ehr.out', 'a'))
...
print("High",file = open('cardio_nd_famd_lr_ehr.out', 'a'))
